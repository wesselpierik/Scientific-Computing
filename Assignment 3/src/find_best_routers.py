...
def find_best_router_locations(results_file, top_n=10):
    ...
    signal_columns = ['living_room_signal', 'bedroom_signal', 'kitchen_signal', 'bathroom_signal']
    ...
    # Get top N results
    top_locations = df_sorted.head(top_n)[['x_r', 'y_r', 'avg_signal', 'min_signal', 'signal_std'] + signal_columns]
...
def print_results(top_locations):
    ...
    print("  - min_signal: Minimum signal strength (lower is better, should be > -70 dB)")
    print("  - signal_std: Standard deviation of signal (lower is better for balanced coverage)")
    print("\n")
...
def main():
    ...
    """
    results_file = '/home/wessel/Documents/Scientific Computing/Assignment 3/src/results.txt'
